		...
		//#region helpers
				...
				*/
				function AccountMeterCard({ wide, t }) {
					...
					if (!wide) {
						const tip = accounts.length === 0
							? t("noAccount")
							: t("dshOnly") + " · " + t("today") + " " + fmtTokens(totalTokens) + " · \u00A5" + fmt(todayCost, 2);
						...
						children: [
							jsx("div", {
								...
								children: [
									...
									accounts.length === 0
										? jsx("span", { className: "ud-main", children: jsx("span", { className: "ud-value", children: t("noAccount") }) })
